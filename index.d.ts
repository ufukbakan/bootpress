...
declare function PassAllQueries<T>(serviceFunction: T): <Z>(...args: Z) => Z extends Parameters<RequestHandler> ? RequestHandler : RequestHandlerWithArgs
...
declare function PassAllCookies<T>(serviceFunction: T): <Z>(...args: Z) => Z extends Parameters<RequestHandler> ? RequestHandler : RequestHandlerWithArgs
declare function PassBody<T>(serviceFunction: T): <Z>(...args: Z) => Z extends Parameters<RequestHandler> ? RequestHandler : RequestHandlerWithArgs
declare function PassRequest<T>(serviceFunction: T): <Z>(...args: Z) => Z extends Parameters<RequestHandler> ? RequestHandler : RequestHandlerWithArgs
